...
X_poly_test = bsxfun(@minus, X_poly_test, mu);%扩充维度，以便符合维度要求
...
%calculate the test error for lambda == 3 in polynomial regression
% lambda = 3;
% [theta] = trainLinearReg(X_poly , y, lambda);
% fprintf('the test error for lambda == 3 is: %.4f\n',...
